...
xTraint=csvread('fOriginalData1.csv',0,0);
xTrain=transpose(xTraint);
tTraint=csvread('trainTargetsencode.csv',0,0);
tTrain=transpose(tTraint);
%%
...
finalSoftmax.trainParam.epochs = 1;
...
finalNetwork.trainParam.epochs = 1;
