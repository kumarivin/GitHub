function [net, errTrn, errTst, errVal, ep, accTrn] = ...
	  bpstvalmcvalout (network, trainset, testset, targets, ...
			   testTargets, numHids, numOuts, ...
			   eta, momentum,kfold, wtMax, debug1)
  %% tuneset, weights1, weights2, outputEpochs, debug2
  klen=size(trainset,1);
  ind=1:klen;
  blocksize=klen/kfold;
  for i=1: kfold
      valind=1:i*blocksize;
