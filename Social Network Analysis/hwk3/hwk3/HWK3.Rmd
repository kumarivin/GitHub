...
#Pt 10 - Bonacich's centrality idea fundamentally conflicts with all other #centrality measures.As per definitiion the more vertices a vertex is connected to#, the more influential a vertex can be.In worst case scenario, there can be many #vertices which are isolated but are connected to only this vertex.
```
